...
import com.fb.android.LKActivity;
...
public class MQTTService extends Service implements MqttSimpleCallback {
	...
	if (isAlreadyConnected() == false) {
	    ...
	    Notification notification = new Notification(R.drawable.alert_dark_frame, "MQTT",
		    System.currentTimeMillis());
	    notification.flags |= Notification.FLAG_ONGOING_EVENT;
	    notification.flags |= Notification.FLAG_NO_CLEAR;
	    Intent notificationIntent = new Intent(this, LKActivity.class);
	...
	NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
	Notification notification = new Notification(R.drawable.alert_dark_frame, alert, System.currentTimeMillis());
